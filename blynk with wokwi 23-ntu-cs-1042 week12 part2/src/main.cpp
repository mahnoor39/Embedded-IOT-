...
#define BLYNK_TEMPLATE_ID "TMPL6h7Xu26wU"
#define BLYNK_TEMPLATE_NAME "dht by mano"
#define BLYNK_AUTH_TOKEN "tNwO4BIfSiGTJVM7Mp3ERm9s7fSe-ZgC" // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
